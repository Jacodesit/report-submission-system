                ...
                <div className='cover-container h-[60vh] rounded-md relative border p-6 '>
                    ...
                    <div className='absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t p-6 rounded-md from-black/80 via-black/40 to-transparent'>
                        <div className='flex gap-4 items-end'>
                            <div className="flex h-32 w-32 items-center justify-center rounded-full bg-primary/90 text-5xl font-semibold text-primary-foreground border-4 border-white shadow-lg ring-2 ring-white/20 flex-shrink-0">
                                {user.avatar ? (
                                    <img
                                        src={user.avatar}
                                        alt={user.name}
